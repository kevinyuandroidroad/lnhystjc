 ...
 <form class="form-horizontal" role="form" id="param_form" action="">
  ...
  <div class="panel panel-default">
   ...
   <div class="panel-body">
    ...
    <div class="row">
     <div class="form-group col-sm-9">
      <label class="col-sm-3 control-label">传输速率</label>
      <div class="col-sm-9">
       <div class="col-sm-6">
        <input class="form-control" id="pro_identity_value" name='pro_${record.proMap["pro_Mbps"].proId }'
         value='${record.proMap["pro_Mbps"].proValue }' type="text" placeholder="数值" />
       </div>
       <div class="col-sm-2">
        <select class="form-control" id="pro_identity_u" name='pro_${record.proMap["pro_Mbps_u"].proId }'>
         <c:forEach var="pro" items="${valid_big_set }">
          <c:if test='${record.proMap["pro_Mbps_u"].proValue eq pro.dicProCode}'>
           <option value="${pro.dicProCode }" selected="selected">${pro.dicProTitle }</option>
          </c:if>
          <c:if test='${record.proMap["pro_Mbps_u"].proValue ne pro.dicProCode }'>
